...
<html lang="en">
  ...
  <body>
    ...
    <!-- Awal Navbar -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary d-print-none"> <!-- menambahkan class "d-print-none" untuk style print -->
    ...
    <h1 class="text-center mt-5 mb-3">Daftar Karyawan</h1>
    <!-- menambahkan link 'Tambah Data Karyawan' ke halaman 1_tambah.php -->
    <!-- menambahkan form untuk search -->

    <form class="m-auto mb-3 ps-3 pe-3 cari d-print-none" method="post"> <!-- menambahkan class "d-print-none" untuk style print -->
    ...
    <!-- ---------------------------------------------------------------------------------------------------- -->
    <div id="container" class="container-fluid"> <!-- menambahkan container untuk batasan ajax -->
    <table cellpadding="10" cellspacing="0" class="m-auto">
      ...
      <tr>
        ...
        <td class="text-center d-print-none"> <!-- menambahkan class "d-print-none" untuk style print -->
