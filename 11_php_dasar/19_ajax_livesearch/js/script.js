// mengambil element2 yang dibutuhkan
var keyword = document.getElementById('keyword');
var cari = document.getElementById('tombolCari');
var container = document.getElementById('container');

// menambahkan event ketika keyword ditulis
keyword.addEventListener('keyup', function() { // keyup berarti saat tombol keyboard dilepas
  ...
  xhr.onreadystatechange = function() {
    if ( xhr.readyState == 4 && xhr.status == 200 ) { // readyState 1,2,3,4 - status 404 file not found
  ...
  xhr.open('GET', 'ajax/karyawan.php?keyword=' + keyword.value, true); // untuk membuka data
